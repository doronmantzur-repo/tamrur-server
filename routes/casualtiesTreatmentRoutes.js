...
router.post("/", authenticate, create_casualty_treatment);
...
router.get("/by-event/:eventId", authenticate, get_casualty_treatments_by_event);
router.get("/by-injury/:injuryId", authenticate, get_casualty_treatments_by_injury);
router.put("/record/:id", authenticate, update_casualty_treatment_by_id);
router.delete("/record/:id", authenticate, delete_casualty_treatment_by_id);
...
router.put("/:eventId", authenticate, update_casualty_treatment);
router.delete("/:eventId", authenticate, delete_casualty_treatment);
router.get("/:eventId", authenticate, get_casualty_treatment_by_event);
